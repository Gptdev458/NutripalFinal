...
interface RecipeConfirmationProps {
    ...
    onConfirm: (choice?: string, portion?: string) => void;
    onDecline: () => void;
}
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden mt-2">
            ...
            <div className="p-4 space-y-4">
                ...
                <div className="space-y-1">
                    ...
                    <div className="max-h-32 overflow-y-auto space-y-1 pr-1 border border-gray-100 rounded p-2 bg-gray-50/30">
