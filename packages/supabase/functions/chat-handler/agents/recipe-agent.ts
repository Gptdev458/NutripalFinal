...
export type RecipeAction =
  ...
  | { type: 'save', parsed: ParsedRecipe, mode?: 'commit' | 'preview', batchNutrition?: any, ingredientsWithNutrition?: any[] };
...
- If the text is NOT a recipe (e.g., "save that recipe"), look for recipe details in the context of a conversation (if provided) or return what you can find.`
      ...
      if (action.type === 'save') {
        ...
        let { batchNutrition, ingredientsWithNutrition } = action as any
