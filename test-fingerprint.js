...
function calculateFingerprint(ingredients) {
    const stopWords = [
        ...
        'ml', 'l', 'liter', 'liters', 'bottle', 'bottles', 'can', 'cans',
        'rolled', 'steel', 'cut', 'instant', 'baby', 'leaves', 'powder',
        'protein', 'isolate', 'shake', 'mix'
    ];
